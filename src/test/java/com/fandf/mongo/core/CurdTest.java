...
import com.fandf.mongo.core.dao.UserDao;
import com.fandf.mongo.core.entity.User;
...
public class CurdTest extends BaseTest {
    ...
    private User getUser() {
        ...
        user.setAddressList(Arrays.asList(User.Address.builder().province("陕西").city("西安").build()));
